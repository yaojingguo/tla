...
\@x{}\moduleLeftDash\@xx{ {\MODULE} TickTock}\moduleRightDash\@xx{}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} TickTock {\p@lbrace}}%
\@x{\@s{16.4} {\p@variable} b \.{=} 0 {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@process} {\p@lparen} Tick \.{=} 0 {\p@rparen}}%
 \@x{\@s{24.59} {\p@lbrace} t0\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{57.93} {\p@lbrace} {\p@await} b \.{=} 0 {\p@semicolon}}%
\@x{\@s{67.51} b \.{:=} 1}%
\@x{\@s{57.93} {\p@rbrace}}%
\@x{\@s{24.59} {\p@rbrace}}%
\@pvspace{8.0pt}%
\@x{\@s{24.59} {\p@process} {\p@lparen} Tock \.{=} 1 {\p@rparen}}%
 \@x{\@s{32.8} {\p@lbrace} t1\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{66.13} {\p@lbrace} {\p@await} b \.{=} 1 {\p@semicolon}}%
\@x{\@s{75.71} b \.{:=} 0}%
\@x{\@s{66.13} {\p@rbrace}}%
\@x{\@s{32.8} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
...
\@pvspace{8.0pt}%
\@x{ Spec\@s{1.78} \.{\defeq} Init \.{\land} {\Box} [ Next ]_{ vars}}%
\@pvspace{8.0pt}%
\@x{}%
\@y{\@s{0}%
 END TRANSLATION
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 04 18:17:32 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Jun} 04
 18:14:34 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\end{lcom}%
\end{document}
