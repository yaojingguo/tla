...
\@x{ Init \.{\defeq} \.{\land} big \.{=} 0}%
\@x{\@s{35.70} \.{\land} small \.{=} 0}%
\@x{ FillSmall \.{\defeq} \.{\land} small \.{'} \.{=} 3}%
\@x{\@s{59.67} \.{\land} big \.{'} \.{=} big}%
\@x{ FillBig \.{\defeq} \.{\land} big \.{'} \.{=}\@s{4.1} 5}%
\@x{\@s{49.69} \.{\land} small \.{'} \.{=} small}%
\@x{ EmptySmall \.{\defeq}\@s{4.1} \.{\land} small \.{'} \.{=} 0}%
\@x{\@s{76.80} \.{\land} big \.{'} \.{=} big}%
\@x{ EmptyBig \.{\defeq} \.{\land} big \.{'} \.{=} 0}%
...
\@x{ BigToSmall \.{\defeq}}%
 ...
 small}%
\@x{\@s{8.2} \.{\IN} \.{\land} big \.{'} \.{=} big \.{-} poured}%
\@x{\@s{28.59} \.{\land} small \.{'} \.{=} small \.{+} poured}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Fri} May 30
 09:25:50 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} May 30 09:12:20
