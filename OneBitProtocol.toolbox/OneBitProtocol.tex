...
\@x{}\moduleLeftDash\@xx{ {\MODULE} OneBitProtocol}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} OneBitProtocol {\p@lbrace}}%
 \@x{\@s{12.29} {\p@variable} x\@s{7.52} \.{\in} [ \{ 0 ,\, 1 \}
 \.{\rightarrow} {\BOOLEAN} ] {\p@semicolon}}%
\@x{\@s{12.29} {\p@process} {\p@lparen} P \.{\in} \{ 0 ,\, 1 \} {\p@rparen}}%
 \@x{\@s{16.4} {\p@lbrace} r\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
 \@x{\@s{41.65} {\p@lbrace}\@s{16.4} {\p@either} {\p@lbrace} {\p@with}
 {\p@lparen} v \.{\in} {\BOOLEAN} {\p@rparen} {\p@lbrace} x [ self ] \.{:=} v
 {\p@rbrace} {\p@semicolon}}%
\@x{\@s{110.38} {\p@goto}\@s{4.1} r}%
\@x{\@s{100.80} {\p@rbrace}}%
\@x{\@s{71.73} {\p@or}\@s{14.74} {\p@skip} {\p@semicolon}}%
 \@x{\@s{49.85} e1\@s{.5}\textrm{:}\@s{3}\@s{5.25} x [ self ] \.{:=} {\TRUE}
 {\p@semicolon}}%
 \@x{\@s{49.85} e2\@s{.5}\textrm{:}\@s{3}\@s{5.25} {\p@if} {\p@lparen} {\lnot}
 x [ 1 \.{-} self ] {\p@rparen} {\p@lbrace} cs\@s{.5}\textrm{:}\@s{3}
 {\p@skip} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{41.65} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{\@s{4.1} {\p@rbrace}}%
\@y{}%
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} x \.{\in} [ \{ 0 ,\, 1 \} \.{\rightarrow} {\BOOLEAN}
 ]}%
\@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto}\@w{r} ]}%
\@pvspace{8.0pt}%
\@x{ r ( self ) \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{r}}%
 \@x{\@s{48.38} \.{\land} \.{\lor} \.{\land} \E\, v\@s{3.95} \.{\in}
 {\BOOLEAN} \.{:}}%
\@x{\@s{89.92} x \.{'} \.{=} [ x {\EXCEPT} {\bang} [ self ] \.{=} v ]}%
 \@x{\@s{70.61} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self
 ]\@s{0.35} \.{=}\@w{r} ]}%
\@x{\@s{59.50} \.{\lor} \.{\land} {\TRUE}}%
 \@x{\@s{70.61} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{e1} ]}%
\@x{\@s{70.61} \.{\land} x \.{'} \.{=} x}%
\@pvspace{8.0pt}%
...
\@x{\@s{53.44} \.{\land} x \.{'} \.{=} x}%
\@pvspace{8.0pt}%
 \@x{ P ( self ) \.{\defeq} r ( self ) \.{\lor} e1 ( self ) \.{\lor} e2 ( self
 ) \.{\lor} cs ( self )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 14:33:44 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Jun} 07 13:31:30
