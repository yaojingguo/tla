...
\@x{}\moduleLeftDash\@xx{ {\MODULE} TickTock2}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\begin{lcom}{5.0}%
...
\@x{\@s{35.70} \.{\land} b \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ TickTock ( self ) \.{\defeq} \.{\land} b \.{=} self}%
\@x{\@s{83.78} \.{\land} b \.{'} \.{=} ( self \.{+} 1 ) \.{\%} 2}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ( \E\, self \.{\in} \{ 0 ,\, 1 \} \.{:} TickTock ( self
 ) )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 08:27:58 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Jun} 07 08:25:45
