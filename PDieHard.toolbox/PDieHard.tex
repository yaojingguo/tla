...
\@x{}\moduleLeftDash\@xx{ {\MODULE} PDieHard}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} DieHard {\p@lbrace}}%
...
\@x{ {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{4.1} \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst}
 \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst}
 \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst}
 \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst}
 \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst} \.{\stst}
 \.{\stst} \.{\stst} \.{\stst} )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 10:20:45 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} May 30 09:55:01
