...
\@x{\@s{42.34} \.{\land} N \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} Euclid {\p@lbrace}}%
\@x{\@s{4.1} {\p@variables} x \.{=} M ,\, y \.{=} N {\p@semicolon}}%
 \@x{\@s{4.1} {\p@lbrace} {\p@while} {\p@lparen} x \.{\neq} y {\p@rparen}
 {\p@lbrace} {\p@if} {\p@lparen} x \.{<} y {\p@rparen} {\p@lbrace} y \.{:=}
 y\@s{0.10} \.{-} x {\p@rbrace}}%
 \@x{\@s{98.81} {\p@else}\@s{24.59} {\p@lbrace} x\@s{9.09} \.{:=} x \.{-} y
 {\p@rbrace}}%
\@x{\@s{89.23} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{4.1} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
\@xx{}%
