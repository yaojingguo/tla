...
\@x{ {\CONSTANTS} M ,\, N}%
\@x{ {\ASSUME} \.{\land} M \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
\@x{\@s{38.24} \.{\land} N\@s{1.53} \.{\in} Nat \.{\,\backslash\,} \{ 0 \}}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
...
\@x{\@s{4.1} {\p@variables} x \.{=} M ,\, y \.{=} N {\p@semicolon}}%
 \@x{\@s{4.1} {\p@lbrace} abc\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} x
 \.{\neq} y {\p@rparen} {\p@lbrace} d\@s{.5}\textrm{:}\@s{3} {\p@if}
 {\p@lparen} x \.{<} y {\p@rparen} {\p@lbrace} y \.{:=} y \.{-} x
 {\p@rbrace}}%
 \@x{\@s{131.88} {\p@else}\@s{32.8} {\p@lbrace} x \.{:=} x \.{-} y
 {\p@rbrace}}%
...
\@x{ {\VARIABLES} x ,\, y ,\, pc}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} x ,\, y ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{37.72} \.{\land} x \.{=} M}%
\@x{\@s{37.72} \.{\land} y\@s{0.10} \.{=} N}%
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{abc}}%
\@pvspace{8.0pt}%
\@x{ abc \.{\defeq} \.{\land} pc \.{=}\@w{abc}}%
\@x{\@s{33.25} \.{\land} {\IF} x \.{\neq} y}%
\@x{\@s{56.52} \.{\THEN} \.{\land} pc \.{'} \.{=}\@w{d}}%
\@x{\@s{56.52} \.{\ELSE} \.{\land} pc \.{'} \.{=}\@w{Done}}%
\@x{\@s{33.25} \.{\land} {\UNCHANGED} {\langle} x ,\, y {\rangle}}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 03 16:21:26 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Tue}
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat May 31 16:03:52 \ensuremath{CST}
 2014 by \ensuremath{jing
}%
\end{cpar}%
\end{lcom}%
\end{document}
