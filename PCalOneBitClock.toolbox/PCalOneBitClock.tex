...
\@x{}\moduleLeftDash\@xx{ {\MODULE} PCalOneBitClock}\moduleRightDash\@xx{}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} Clock {\p@lbrace}}%
\@x{\@s{12.29} {\p@variable} b \.{\in} \{ 0 ,\, 1 \} {\p@semicolon}}%
 \@x{\@s{12.29} {\p@lbrace} {\p@while} {\p@lparen} {\TRUE} {\p@rparen}
 {\p@lbrace} {\p@if} {\p@lparen} b\@s{4.1} \.{=} 0 {\p@rparen} b \.{:=} 1
 {\p@else} b \.{:=} 0}%
\@x{\@s{116.06} {\p@rbrace}}%
\@x{\@s{12.29} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
...
\@x{ {\VARIABLE} b}%
\@pvspace{8.0pt}%
\@x{ vars\@s{2.10} \.{\defeq} {\langle} b {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{4.12} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{39.83} \.{\land} b \.{\in} \{ 0 ,\, 1 \}}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} {\IF} b\@s{4.1} \.{=} 0}%
\@x{\@s{51.98} \.{\THEN} \.{\land} b \.{'} \.{=} 1}%
\@x{\@s{51.98} \.{\ELSE} \.{\land} b \.{'} \.{=} 0}%
\@pvspace{8.0pt}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified \ensuremath{Thu} May 29
 15:14:15 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Thu} May 29 15:08:52
