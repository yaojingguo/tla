...
\@x{}\moduleLeftDash\@xx{ {\MODULE} AltSpec}\moduleRightDash\@xx{}%
\begin{lcom}{5.0}%
...
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@variables} b \.{=} 0 {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@process} {\p@lparen} Producers \.{=} 0 {\p@rparen}}%
...
\@x{\@s{66.30} cx\@s{.5}\textrm{:}\@s{3} b \.{:=} 0\@s{32.8} {\p@rbrace}}%
\@x{\@s{24.59} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
\@xx{}%
...
\@x{ {\VARIABLES} b ,\, pc}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} b ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{29.84} \.{\land} b \.{'} \.{=} 1}%
 ...
 \.{=}\@w{pe} ]}%
\@pvspace{8.0pt}%
\@x{ Producers \.{\defeq} pe \.{\lor} put \.{\lor} px}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} Producers \.{\lor} Consumer}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 06 16:09:46 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Jun} 06
 16:06:16 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\end{lcom}%
\end{document}
