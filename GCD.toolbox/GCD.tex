...
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\@x{ Divides ( p ,\, n ) \.{\defeq}\@s{53.3}}%
\begin{mcom}{228.88}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
For integers \ensuremath{p} and \ensuremath{n}, equals
 \ensuremath{{\TRUE}} iff \ensuremath{p} divides \ensuremath{n} -- which
 I think is really neat; don\mbox{'}t
 you\.{?}
\end{cpar}%
\end{mcom}%
\@x{\@s{24.59} \E\, q \.{\in} Int \.{:}\@s{58.39}}%
\@x{\@s{49.60} n \.{=} q \.{*} p\@s{41.11}}%
\multivspace{3}%
\@pvspace{8.0pt}%
 \@x{ DivisorsOf ( n ) \.{\defeq} \{ p \.{\in} Int \.{:} Divides ( p ,\, n )
 \}}%
\@x{ SetMax ( S ) \.{\defeq}}%
 \@x{\@s{16.4} {\CHOOSE} i \.{\in} S \.{:} \A\, j \.{\in} S \.{:} i \.{\geq}
 j}%
\@x{}%
\@y{\@s{0}%
 This is all text
...
\@xx{}%
\@x{ GCD ( m ,\, n ) \.{\defeq}}%
\@x{\@s{23.38} SetMax ( DivisorsOf ( m ) \.{\cap} DivisorsOf ( n ) )}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Last modified Sat May 31 15:55:06
 \ensuremath{CST} 2014 by \ensuremath{jing
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created Sat May 31 09:50:23
 \ensuremath{CST} 2014 by \ensuremath{jing
}%
\end{cpar}%
\end{lcom}%
