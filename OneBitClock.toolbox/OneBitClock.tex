...
\@x{\@s{55.94} \.{\land} b \.{'} \.{=} 0}%
\@x{ Next2 \.{\defeq} b \.{'} \.{=} {\IF} b \.{=} 0 \.{\THEN} 1 \.{\ELSE} 0}%
\@pvspace{8.0pt}%
\@x{ Next3 \.{\defeq} b \.{'} \.{=} ( b \.{+} 1 ) \.{\%} 2}%
\@pvspace{16.0pt}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 14:57:31 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Mon} May 26 21:18:44
