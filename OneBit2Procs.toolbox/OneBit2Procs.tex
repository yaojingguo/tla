...
\@x{}\moduleLeftDash\@xx{ {\MODULE} OneBit2Procs}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
...
\@x{ {\p@mmalgorithm} OneBit {\p@lbrace}}%
 ...
 {\TRUE} {\p@rparen}}%
\@x{\@s{55.59} {\p@lbrace}\@s{20.5} {\p@skip} {\p@semicolon}}%
 \@x{\@s{63.79} e1\@s{.5}\textrm{:}\@s{3}\@s{5.25} x [ self ] \.{:=} {\TRUE}
 {\p@semicolon}}%
 \@x{\@s{63.79} e2\@s{.5}\textrm{:}\@s{3}\@s{5.25} {\p@if} {\p@lparen} {\lnot}
 x [ 1 \.{-} self ] {\p@rparen} {\p@lbrace} cs\@s{.5}\textrm{:}\@s{3}
 {\p@skip} {\p@rbrace}}%
 \@x{\@s{85.67} {\p@else} {\p@lbrace} {\p@if} {\p@lparen} self \.{=} 0
 {\p@rparen} {\p@lbrace} {\p@goto} e2 {\p@rbrace}}%
 \@x{\@s{117.36} {\p@else} {\p@lbrace} e3\@s{.5}\textrm{:}\@s{3} x [ 1 ]
 \.{:=} {\FALSE} {\p@semicolon}}%
 \@x{\@s{149.05} e4\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen} x [ 0 ]
 {\p@rparen} {\p@lbrace} {\p@skip} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{165.68} {\p@goto} e1}%
\@x{\@s{139.47} {\p@rbrace}}%
\@x{\@s{107.78} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{63.79} f\@s{.5}\textrm{:}\@s{3}\@s{10.41} x [ self ] \.{:=} {\FALSE}}%
\@x{\@s{55.59} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{\@s{4.1} {\p@rbrace}}%
\@y{}%
...
\@x{\@s{53.44} \.{\land} x \.{'} \.{=} x}%
\@pvspace{8.0pt}%
\@x{ f ( self )\@s{2.62} \.{\defeq} \.{\land} pc [ self ] \.{=}\@w{f}}%
 \@x{\@s{50.90} \.{\land} x \.{'} \.{=} [ x {\EXCEPT} {\bang} [ self ] \.{=}
 {\FALSE} ]}%
 \@x{\@s{50.90} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ self ]
 \.{=}\@w{ncs} ]}%
\@pvspace{8.0pt}%
 \@x{ P ( self ) \.{\defeq} ncs ( self ) \.{\lor} e1 ( self ) \.{\lor} e2 (
 self ) \.{\lor} cs ( self ) \.{\lor} e3 ( self )}%
\@x{\@s{66.03} \.{\lor} e4 ( self ) \.{\lor} f ( self )}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} ( \E\, self \.{\in} \{ 0 ,\, 1 \} \.{:} P ( self ) )}%
\@pvspace{8.0pt}%
...
\@x{ MutualExclusion \.{\defeq} {\lnot} ( InCS ( 0 ) \.{\land} InCS ( 1 ) )}%
 \@x{ pcBar \.{\defeq} [ i \.{\in} \{ 0 ,\, 1 \} \.{\mapsto} {\IF} pc [ i ]
 \.{\in} \{\@w{ncs} ,\,\@w{f} \} \.{\THEN}\@w{r}}%
\@x{\@s{204.90} \.{\ELSE} pc [ i ] ]}%
\@x{ A \.{\defeq} {\INSTANCE} OneBitProtocol {\WITH} x \.{\leftarrow} x ,\,}%
\@x{\@s{171.43} pc \.{\leftarrow} pcBar}%
 \@x{ Trying ( i ) \.{\defeq} pc [ i ] \.{\in} {\IF} i \.{=} 0 \.{\THEN}
 \{\@w{e1} ,\,\@w{e2} \}}%
\@x{\@s{127.70} \.{\ELSE} \{\@w{e1} ,\,\@w{e2} ,\,\@w{e3} ,\,\@w{e4} \}}%
...
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Last modified Sat \ensuremath{Jun} 07
 15:59:59 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Jun} 07 15:15:55
 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\end{lcom}%
\end{document}
