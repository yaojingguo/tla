...
\@x{}\moduleLeftDash\@xx{ {\MODULE} SetEuclid}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers ,\, GCD ,\, FiniteSets}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmfair} {\p@algorithm} SetEuclid {\p@lbrace}}%
\@x{\@s{4.1} {\p@variables} S \.{=} \{ 2 ,\, 4 ,\, 6 \} {\p@semicolon}}%
 \@x{\@s{4.1} {\p@lbrace} {\p@while} {\p@lparen} Cardinality ( S ) \.{>} 1
 {\p@rparen} {\p@lbrace} {\p@with} {\p@lparen} x \.{\in} S ,\, y \.{\in} \{ s
 \.{\in} S \.{:} s \.{>} x \} {\p@rparen}}%
 \@x{\@s{164.59} {\p@lbrace} S \.{:=} ( S \.{\,\backslash\,} \{ y \} )
 \.{\cup} \{ y \.{-} x \} {\p@rbrace}}%
\@x{\@s{146.81} {\p@rbrace} {\p@semicolon}}%
\@x{\@s{4.1} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
\@xx{}%
...
\@x{ {\VARIABLES} S ,\, pc}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} S ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{2.02} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{37.72} \.{\land} S \.{=} \{ 2 ,\, 4 ,\, 6 \}}%
\@x{\@s{37.72} \.{\land} pc \.{=}\@w{Lbl\_1}}%
\@pvspace{8.0pt}%
\@x{ Lbl\_1 \.{\defeq} \.{\land} pc \.{=}\@w{Lbl\_1}}%
\@x{\@s{42.84} \.{\land} {\IF} Cardinality ( S ) \.{>} 1}%
\@x{\@s{66.11} \.{\THEN} \.{\land} \E\, x \.{\in} S \.{:}}%
 \@x{\@s{116.73} \E\, y\@s{4.86} \.{\in} \{ s \.{\in} S \.{:} s \.{>} x \}
 \.{:}}%
 \@x{\@s{124.93} S \.{'} \.{=} ( ( S \.{\,\backslash\,} \{ y \} ) \.{\cup} \{
 y \.{-} x \} )}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 04 10:56:57 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}\.{*}} Created \ensuremath{Wed}
 \ensuremath{Jun} 04 10:23:24 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\end{lcom}%
\end{document}
