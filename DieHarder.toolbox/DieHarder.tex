...
\@x{ {\ASSUME} \.{\land} Goal \.{\in} Nat}%
 \@x{\@s{38.24} \.{\land} Capacity \.{\in} [ Jugs \.{\mapsto} Nat
 \.{\,\backslash\,} \{ 0 \} ]}%
\@pvspace{8.0pt}%
\begin{lcom}{5.0}%
...
\@y{\@s{0}%
 pour from jug \ensuremath{j} to jug \ensuremath{k
}}%
\@xx{}%
\@x{\@s{72.83} {\p@lbrace} {\p@with} {\p@lparen} poured \.{=}}%
 ...
 \.{-} poured \.{\p@barbar}}%
\@x{\@s{100.20} injug [ k ] \.{:=} injug [ k ] \.{+} poured {\p@semicolon}}%
\@x{\@s{90.61} {\p@rbrace}}%
\@x{\@s{72.83} {\p@rbrace}}%
\@x{\@s{21.88} {\p@rbrace}}%
\@x{\@s{8.2} {\p@rbrace}}%
...
\@x{ {\VARIABLE} injug}%
\@pvspace{8.0pt}%
\@x{ vars\@s{2.10} \.{\defeq} {\langle} injug {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Init\@s{4.12} \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{39.83} \.{\land} injug \.{=} [ j \.{\in} Jugs \.{\mapsto} 0 ]}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} \.{\lor} \.{\land} \E\, j \.{\in} Jugs \.{:}}%
 \@x{\@s{70.25} injug \.{'} \.{=} [ injug {\EXCEPT} {\bang} [ j ] \.{=}
 Capacity [ j ] ]}%
\@x{\@s{39.83} \.{\lor} \.{\land} \E\, j \.{\in} Jugs \.{:}}%
\@x{\@s{70.25} injug \.{'} \.{=} [ injug {\EXCEPT} {\bang} [ j ] \.{=} 0 ]}%
\@x{\@s{39.83} \.{\lor} \.{\land} \E\, j \.{\in} Jugs \.{:}}%
\@x{\@s{70.25} \E\, k \.{\in} Jugs \.{\,\backslash\,} \{ j \} \.{:}}%
 \@x{\@s{78.45} \.{\LET} poured \.{\defeq} Min ( injug [ j ] \.{+} injug [ k ]
 ,\, Capacity [ k ] ) \.{-} injug [ k ] \.{\IN}}%
 \@x{\@s{86.65} injug \.{'} \.{=} [ injug {\EXCEPT} {\bang} [ j ]\@s{1.16}
 \.{=} injug [ j ]\@s{1.16} \.{-} poured ,\,}%
\@x{\@s{192.80} {\bang} [ k ] \.{=} injug [ k ] \.{+} poured ]}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 04 15:57:15 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Jun} 04
 14:07:37 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\end{lcom}%
\end{document}
