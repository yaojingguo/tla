...
\@x{ {\p@mmalgorithm} Handshake {\p@lbrace}}%
 \@x{\@s{4.1} {\p@variables} p \.{=} 0 ,\, c\@s{5.21} \.{=} 0 ,\, box \.{=}
 {\langle} {\rangle} {\p@semicolon}}%
\@x{\@s{4.1} {\p@process} {\p@lparen} Producer \.{=} 0 {\p@rparen}}%
 \@x{\@s{12.29} {\p@lbrace} p1\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{43.00} {\p@lbrace} {\p@await} p \.{=}\@s{4.1} c {\p@semicolon}}%
\@x{\@s{52.58} box \.{:=} Put ( box ) {\p@semicolon}}%
\@x{\@s{52.58} p \.{:=} p \.{\oplus} 1}%
\@x{\@s{47.10} {\p@rbrace}}%
\@x{\@s{12.29} {\p@rbrace}}%
\@x{\@s{4.1} {\p@process} {\p@lparen} Consumer \.{=} 1 {\p@rparen}}%
 \@x{\@s{12.29} {\p@lbrace} c1\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{42.42} {\p@lbrace} {\p@await} p \.{\neq} c {\p@semicolon}}%
\@x{\@s{52.00} box \.{:=} Get ( box ) {\p@semicolon}}%
\@x{\@s{52.00} c \.{:=} c \.{\oplus} 1}%
\@x{\@s{42.42} {\p@rbrace}}%
\@x{\@s{12.29} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@x{ {\VARIABLES} p ,\, c ,\, box}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} p ,\, c ,\, box {\rangle}}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{ Producer\@s{5.86} \.{\defeq} \.{\land} p \.{=}\@s{4.1} c}%
\@x{\@s{64.30} \.{\land} box \.{'} \.{=} Put ( box )}%
\@x{\@s{64.30} \.{\land} p \.{'} \.{=} p \.{\oplus} 1}%
\@x{\@s{64.30} \.{\land} c \.{'}\@s{0.57} \.{=} c}%
\@pvspace{8.0pt}%
\@x{ Consumer \.{\defeq} \.{\land} p \.{\neq} c}%
\@x{\@s{64.30} \.{\land} box \.{'} \.{=} Get ( box )}%
\@x{\@s{64.30} \.{\land} c \.{'}\@s{0.57} \.{=} c \.{\oplus} 1}%
\@x{\@s{64.30} \.{\land} p \.{'} \.{=} p}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 05 14:48:50 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
