...
\@x{}\moduleLeftDash\@xx{ {\MODULE} ClockSpec}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\CONSTANT} N}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} ClockSpec {\p@lbrace}}%
\@x{\@s{8.2} {\p@variable} c \.{=} 0 {\p@semicolon}}%
\@pvspace{8.0pt}%
 \@x{\@s{8.2} {\p@process} {\p@lparen} Tick \.{\in} 0 \.{\dotdot} ( N \.{-} 1
 ) {\p@rparen}}%
 \@x{\@s{16.4} {\p@lbrace} t\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{40.63} {\p@lbrace} {\p@await} c \.{=} self {\p@semicolon}}%
\@x{\@s{50.21} c \.{:=} ( c \.{+} 1 ) \.{\%} N}%
\@x{\@s{40.63} {\p@rbrace}}%
\@x{\@s{20.5} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
...
\@x{\@s{35.70} \.{\land} c \.{=} 0}%
\@pvspace{8.0pt}%
\@x{ Tick ( self ) \.{\defeq} \.{\land} c \.{=} self}%
\@x{\@s{63.59} \.{\land} c \.{'} \.{=} ( c \.{+} 1 ) \.{\%} N}%
\@pvspace{8.0pt}%
 \@x{ Next \.{\defeq} ( \E\, self \.{\in} 0 \.{\dotdot} ( N \.{-} 1 ) \.{:}
 Tick ( self ) )}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 08:37:57 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Jun} 07 08:31:09
