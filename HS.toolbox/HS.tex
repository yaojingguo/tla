...
\@x{\@s{16.4} {\p@process} {\p@lparen} Consumer \.{=} 1 {\p@rparen}}%
 ...
 {\TRUE} {\p@rparen}}%
\@x{\@s{58.10} {\p@lbrace}\@s{20.5} {\p@await} p \.{\neq} c {\p@semicolon}}%
...
\@x{ {\VARIABLES} p ,\, c ,\, pc}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} p ,\, c ,\, pc {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{28.83} \.{\land} p \.{=}\@s{4.1} c}%
 \@x{\@s{28.83} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{put} ]}%
\@x{\@s{28.83} \.{\land} {\UNCHANGED} {\langle} p ,\, c {\rangle}}%
\@pvspace{8.0pt}%
\@x{ put \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{put}}%
\@x{\@s{33.63} \.{\land} {\TRUE}}%
 \@x{\@s{33.63} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{px} ]}%
\@x{\@s{33.63} \.{\land} {\UNCHANGED} {\langle} p ,\, c {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{29.84} \.{\land} c \.{'} \.{=} c}%
\@pvspace{8.0pt}%
\@x{ Producer \.{\defeq} pe \.{\lor} put \.{\lor} px}%
\@pvspace{8.0pt}%
\@x{ ce \.{\defeq} \.{\land} pc [ 1 ] \.{=}\@w{ce}}%
\@x{\@s{28.32} \.{\land} p \.{\neq} c}%
 \@x{\@s{28.32} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{get} ]}%
\@x{\@s{28.32} \.{\land} {\UNCHANGED} {\langle} p ,\, c {\rangle}}%
\@pvspace{8.0pt}%
\@x{ get \.{\defeq} \.{\land} pc [ 1 ] \.{=}\@w{get}}%
\@x{\@s{32.35} \.{\land} {\TRUE}}%
 \@x{\@s{32.35} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{cx} ]}%
\@x{\@s{32.35} \.{\land} {\UNCHANGED} {\langle} p ,\, c {\rangle}}%
\@pvspace{8.0pt}%
...
\@x{\@s{29.33} \.{\land} p \.{'} \.{=} p}%
\@pvspace{8.0pt}%
\@x{ Consumer \.{\defeq} ce \.{\lor} get \.{\lor} cx}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 06 16:33:09 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Jun} 06
 16:27:49 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\end{lcom}%
\end{document}
