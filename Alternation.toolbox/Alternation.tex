...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} Alternate {\p@lbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{16.4} {\p@variable} b \.{=} 0 ,\, box \.{=} {\langle} {\rangle}
 {\p@semicolon}}%
\@pvspace{8.0pt}%
 \@x{\@s{16.4} {\p@fair} {\p@process} {\p@lparen} Producer \.{=} 0
 {\p@rparen}}%
...
\@x{ {\VARIABLES} b ,\, box}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} b ,\, box {\rangle}}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{ Producer\@s{5.86} \.{\defeq} \.{\land} b \.{=} 0}%
\@x{\@s{64.30} \.{\land} box \.{'} \.{=} Put ( box )}%
\@x{\@s{64.30} \.{\land} b \.{'} \.{=} 1}%
\@pvspace{8.0pt}%
\@x{ Consumer \.{\defeq} \.{\land} b \.{=} 1}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 05 09:38:27 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Wed} \ensuremath{Jun} 04
 18:06:04 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\end{lcom}%
\end{document}
