...
\@x{}\moduleLeftDash\@xx{ {\MODULE} FHS}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@pvspace{8.0pt}%
...
\@pvspace{8.0pt}%
\@x{\@s{16.4} {\p@variables} p \.{=} 0 ,\, c\@s{5.21} \.{=} 0 {\p@semicolon}}%
\@x{\@s{16.4} {\p@process} {\p@lparen} Producer \.{=} 0 {\p@rparen}}%
\@x{\@s{24.59} {\p@variable} tp \.{=} 0 {\p@semicolon}}%
 \@x{\@s{24.59} {\p@lbrace} pe\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{58.61} {\p@lbrace}\@s{20.5} tp \.{:=} c {\p@semicolon}}%
 \@x{\@s{66.81} pe1\@s{.5}\textrm{:}\@s{3}\@s{0.65} {\p@if} {\p@lparen} p
...
\@x{\@s{24.59} {\p@variable} tc \.{=} 0 {\p@semicolon}}%
 \@x{\@s{24.59} {\p@lbrace} ce\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
\@x{\@s{58.10} {\p@lbrace}\@s{20.5} tc \.{:=} p {\p@semicolon}}%
 \@x{\@s{66.30} ce1\@s{.5}\textrm{:}\@s{3}\@s{1.16} {\p@if} {\p@lparen} c
 \.{=} tc {\p@rparen} {\p@lbrace} {\p@goto} ce {\p@rbrace} {\p@semicolon}}%
\@x{\@s{66.30} get\@s{.5}\textrm{:}\@s{3}\@s{2.13} {\p@skip} {\p@semicolon}}%
 \@x{\@s{66.30} cx\@s{.5}\textrm{:}\@s{3}\@s{5.16} c \.{:=} c \.{\oplus}
 1\@s{4.1} {\p@rbrace}}%
\@x{\@s{24.59} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@xx{}%
\@x{ {\VARIABLES} p ,\, c ,\, pc ,\, tp ,\, tc}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} p ,\, c ,\, pc ,\, tp ,\, tc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} \{ 0 \} \.{\cup} \{ 1 \}}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
\@x{\@s{35.70} \.{\land} p \.{=} 0}%
\@x{\@s{35.70} \.{\land} c\@s{0.57} \.{=} 0}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process \ensuremath{Producer
}}%
\@xx{}%
\@x{\@s{35.70} \.{\land} tp \.{=} 0}%
\@x{\@s{35.70}}%
\@y{\@s{0}%
 Process \ensuremath{Consumer
}}%
\@xx{}%
\@x{\@s{35.70} \.{\land} tc\@s{1.27} \.{=} 0}%
 \@x{\@s{35.70} \.{\land} pc \.{=} [ self \.{\in} ProcSet \.{\mapsto} {\CASE}
 self \.{=} 0 \.{\rightarrow}\@w{pe}}%
\@x{\@s{160.39} {\Box}\@s{10.30} self \.{=} 1 \.{\rightarrow}\@w{ce} ]}%
\@pvspace{8.0pt}%
\@x{ pe \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{pe}}%
\@x{\@s{28.83} \.{\land} tp \.{'}\@s{0.70} \.{=} c}%
 \@x{\@s{28.83} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{pe1} ]}%
\@x{\@s{28.83} \.{\land} {\UNCHANGED} {\langle} p ,\, c ,\, tc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ pe1 \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{pe1}}%
\@x{\@s{33.83} \.{\land} {\IF} p \.{\neq} tp}%
 \@x{\@s{57.10} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0
 ] \.{=}\@w{pe} ]}%
 \@x{\@s{57.10} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0
 ] \.{=}\@w{put} ]}%
 \@x{\@s{33.83} \.{\land} {\UNCHANGED} {\langle} p ,\, c ,\, tp ,\, tc
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ put\@s{0.20} \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{put}}%
\@x{\@s{33.83} \.{\land} {\TRUE}}%
 \@x{\@s{33.83} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{px} ]}%
 \@x{\@s{33.83} \.{\land} {\UNCHANGED} {\langle} p ,\, c ,\, tp ,\, tc
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ px \.{\defeq} \.{\land} pc [ 0 ] \.{=}\@w{px}}%
\@x{\@s{29.84} \.{\land} p \.{'} \.{=} p \.{\oplus} 1}%
 \@x{\@s{29.84} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 0 ]
 \.{=}\@w{pe} ]}%
\@x{\@s{29.84} \.{\land} {\UNCHANGED} {\langle} c ,\, tp ,\, tc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Producer \.{\defeq} pe \.{\lor} pe1 \.{\lor} put \.{\lor} px}%
\@pvspace{8.0pt}%
\@x{ ce \.{\defeq} \.{\land} pc [ 1 ] \.{=}\@w{ce}}%
\@x{\@s{28.32} \.{\land} tc \.{'}\@s{1.27} \.{=} p}%
 \@x{\@s{28.32} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{ce1} ]}%
\@x{\@s{28.32} \.{\land} {\UNCHANGED} {\langle} p ,\, c ,\, tp {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ce1 \.{\defeq} \.{\land} pc [ 1 ] \.{=}\@w{ce1}}%
\@x{\@s{33.32} \.{\land} {\IF} c \.{=} tc}%
 \@x{\@s{56.59} \.{\THEN} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1
 ] \.{=}\@w{ce} ]}%
 \@x{\@s{56.59} \.{\ELSE} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1
 ] \.{=}\@w{get} ]}%
 \@x{\@s{33.32} \.{\land} {\UNCHANGED} {\langle} p ,\, c ,\, tp ,\, tc
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ get\@s{0.96} \.{\defeq} \.{\land} pc [ 1 ] \.{=}\@w{get}}%
\@x{\@s{33.32} \.{\land} {\TRUE}}%
 \@x{\@s{33.32} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{cx} ]}%
 \@x{\@s{33.32} \.{\land} {\UNCHANGED} {\langle} p ,\, c ,\, tp ,\, tc
 {\rangle}}%
\@pvspace{8.0pt}%
\@x{ cx \.{\defeq} \.{\land} pc [ 1 ] \.{=}\@w{cx}}%
\@x{\@s{29.33} \.{\land} c \.{'} \.{=} c \.{\oplus} 1}%
 \@x{\@s{29.33} \.{\land} pc \.{'} \.{=} [ pc {\EXCEPT} {\bang} [ 1 ]
 \.{=}\@w{ce} ]}%
\@x{\@s{29.33} \.{\land} {\UNCHANGED} {\langle} p ,\, tp ,\, tc {\rangle}}%
\@pvspace{8.0pt}%
\@x{ Consumer \.{\defeq} ce \.{\lor} ce1 \.{\lor} get \.{\lor} cx}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} Producer \.{\lor} Consumer}%
\@pvspace{8.0pt}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 \ensuremath{Jun} 06 16:47:38 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created \ensuremath{Fri} \ensuremath{Jun} 06
 16:40:53 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\end{lcom}%
\end{document}
