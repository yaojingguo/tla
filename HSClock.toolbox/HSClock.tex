...
\@x{}\moduleLeftDash\@xx{ {\MODULE} HSClock}\moduleRightDash\@xx{}%
\@x{ {\EXTENDS} Integers}%
\@x{ {\CONSTANT} N}%
...
\pcalshadingtrue
\csyntaxtrue
\@x{ {\p@mmalgorithm} HSClock {\p@lbrace}}%
 \@x{\@s{8.2} {\p@variable} ca \.{=} [ i \.{\in} 0 \.{\dotdot} ( N \.{-} 1 )
 \.{\mapsto} 0 ] {\p@semicolon}}%
\@pvspace{8.0pt}%
\@x{\@s{8.2} {\p@process} {\p@lparen} Proc0 \.{=} 0 {\p@rparen}}%
 \@x{\@s{16.4} {\p@lbrace} t\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
 \@x{\@s{40.63} {\p@lbrace} {\p@await} ca [ 0 ] \.{=} ca [ N \.{-} 1 ]
 {\p@semicolon}}%
\@x{\@s{50.21} ca [ 0 ] \.{:=} ca [ 0 ] \.{\oplus} 1}%
\@x{\@s{40.63} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@pvspace{8.0pt}%
 \@x{\@s{8.2} {\p@process} {\p@lparen} Proc \.{\in} 1 \.{\dotdot} ( N \.{-} 1
 ) {\p@rparen}}%
 \@x{\@s{16.4} {\p@lbrace} t\@s{.5}\textrm{:}\@s{3} {\p@while} {\p@lparen}
 {\TRUE} {\p@rparen}}%
 \@x{\@s{40.63} {\p@lbrace} {\p@await} ca [ self ] \.{\neq} ca [ self \.{-} 1
 ] {\p@semicolon}}%
\@x{\@s{50.21} ca [ self ] \.{:=} ca [ self ] \.{\oplus}\@s{4.1} 1}%
\@x{\@s{40.63} {\p@rbrace}}%
\@x{\@s{16.4} {\p@rbrace}}%
\@x{ {\p@rbrace}}%
\@y{}%
...
\@x{}%
\@y{\@s{0}%
 Label t of process \ensuremath{Proc0} at line 11 col 10 changed to
 \ensuremath{t\_
}}%
\@xx{}%
\@x{ {\VARIABLE} ca}%
\@pvspace{8.0pt}%
\@x{ vars \.{\defeq} {\langle} ca {\rangle}}%
\@pvspace{8.0pt}%
\@x{ ProcSet \.{\defeq} \{ 0 \} \.{\cup} ( 1 \.{\dotdot} ( N \.{-} 1 ) )}%
\@pvspace{8.0pt}%
\@x{ Init \.{\defeq}}%
\@y{\@s{0}%
 Global variables
...
\@xx{}%
 \@x{\@s{35.70} \.{\land} ca \.{=} [ i \.{\in} 0 \.{\dotdot} ( N \.{-} 1 )
 \.{\mapsto} 0 ]}%
\@pvspace{8.0pt}%
\@x{ Proc0 \.{\defeq} \.{\land} ca [ 0 ] \.{=} ca [ N \.{-} 1 ]}%
 \@x{\@s{44.14} \.{\land} ca \.{'} \.{=} [ ca {\EXCEPT} {\bang} [ 0 ] \.{=} ca
 [ 0 ] \.{\oplus} 1 ]}%
\@pvspace{8.0pt}%
 \@x{ Proc ( self ) \.{\defeq} \.{\land} ca [ self ] \.{\neq} ca [ self \.{-}
 1 ]}%
 \@x{\@s{63.35} \.{\land} ca \.{'} \.{=} [ ca {\EXCEPT} {\bang} [ self ] \.{=}
 ca [ self ] \.{\oplus}\@s{4.1} 1 ]}%
\@pvspace{8.0pt}%
\@x{ Next \.{\defeq} Proc0}%
 \@x{\@s{52.13} \.{\lor} ( \E\, self \.{\in} 1 \.{\dotdot} ( N \.{-} 1 ) \.{:}
 Proc ( self ) )}%
\@pvspace{8.0pt}%
...
\@xx{}%
 \@x{ cBar \.{\defeq} {\IF} \E\, i \.{\in} 1 \.{\dotdot} ( N \.{-} 1 ) \.{:}
 ca [ i ] \.{\neq} ca [ i \.{-} 1 ]}%
 \@x{\@s{49.13} \.{\THEN} {\CHOOSE} i \.{\in} 1 \.{\dotdot} ( N \.{-} 1 )
 \.{:} ca [ i ] \.{\neq} ca [ i \.{-} 1 ]}%
\@x{\@s{49.13} \.{\ELSE} 0}%
\@x{ CS \.{\defeq} {\INSTANCE} ClockSpec {\WITH} c \.{\leftarrow} cBar}%
\@x{}\bottombar\@xx{}%
\setboolean{shading}{false}
\begin{lcom}{0}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
...
\begin{cpar}{0}{F}{F}{0}{0}{}%
 ...
 09:20:00 \ensuremath{CST} 2014 by \ensuremath{yaojingguo
}%
\end{cpar}%
\begin{cpar}{0}{F}{F}{0}{0}{}%
 \ensuremath{\.{\,\backslash\,}}* Created Sat \ensuremath{Jun} 07 08:43:34
